        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center gap-2 px-6 py-5 border-b border-border">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-foreground">BlitzClaw</span>
            </Link>
          </div>
          ...
          <div className="px-3 pb-4">
            <Link
              ...
              onClick={() => setSidebarOpen(false)}
              className="flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
